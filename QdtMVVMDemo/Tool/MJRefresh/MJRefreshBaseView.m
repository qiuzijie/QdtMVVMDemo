...
- (void)setState:(MJRefreshState)state
{
    ...
    switch (state) {
		...
		case MJRefreshStateRefreshing:
        {
            ...
            if (self.beginRefreshingCommand) {
                [self.beginRefreshingCommand execute:@(([self refreshViewType] == MJRefreshViewTypeFooter))];
            }
...
- (void)setBeginRefreshingCommand:(RACCommand *)beginRefreshingCommand{
    _beginRefreshingCommand = beginRefreshingCommand;
    [[_beginRefreshingCommand.executing skipUntilBlock:^BOOL(NSNumber *value) {
...
- (MJRefreshViewType)refreshViewType{
